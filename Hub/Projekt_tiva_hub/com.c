...
//  SYSCTL_RCGCGPIO_R |= SYSCTL_RCGCGPIO_R2;
    SYSCTL_RCGC2_R |= SYSCTL_RCGC2_GPIOC; // Enable the clock to the port by setting the appropriate bits
    vTaskDelay(10 / portTICK_RATE_MS);
    GPIO_PORTC_DIR_R &= ~(PIN_COM_0 | PIN_COM_1); // A write a 1 = output and a write of a 0 = input.
    GPIO_PORTC_DEN_R |= (PIN_COM_0 | PIN_COM_1); // The digital functions for the corresponding pin are enabled.
